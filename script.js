...
$("#accordion img").on( "mouseover", function() {
   var initialImageSrc = $('#accordion .slick-slider').find('.slick-current img').attr('src');
    $('#load').css('background','url(' + initialImageSrc + ') no-repeat center center rgba(0,0,0,1)!important');
...
$("#accordion img").on( "mouseout", function() {
